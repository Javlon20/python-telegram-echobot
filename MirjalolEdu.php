<?php
$admin = "5446861624";
$token = '6033347317:AAGc61A6N7n19G0HGH4ZeX87xWZ6-re8VmQ';
$mybot="MirjalolEduTestbot";
...
if($text=="/start@mirjalol_education" or $text=="/start" or mb_stripos($text,"qwertyuiop")!==false){
if($ism==false){
file_put_contents("step/$cid.txt","ism");
        bot('SendMessage',[
   'chat_id'=>$cid,
        'text'=>"<b>Ismingizni kiriting!!!
misol: Hamza Hamrayiv</b>
...
Bu bot Mirjalol Education Rasmiy
boti ☝🏻</b>

👨🏻‍💻 Adminstrator: <a href='tg://user?id=1061669459'>Hamza Hamrayiv</a>
...
<b><u>⏳ $vaqt | 📆 $sana </u></b>",
    ...
    'reply_markup'=>[
            'inline_keyboard'=>[
 [['text'=>"Testga javob berish!",'url'=>"https://t.me/$bot?start="]],
        ]],
        ]
        ])
]);
